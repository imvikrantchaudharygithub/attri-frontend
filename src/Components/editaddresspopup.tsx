...
export default function EditAddressPopUp({ address, onClose, onSaved }: EditAddressPopUpProps) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      mobileNumber: address?.contact ?? user?.phone ?? "",
      pincode: address?.pincode ?? "",
      state: address?.state ?? "",
      city: address?.city ?? "",
      streetAddress: address?.street ?? "",
      addressType: (address?.type === "office" ? "office" : "home") as "home" | "office",
    },
    ...
    onSubmit: async (values) => {
      ...
      try {
        const res: any = await postData("update-address", data);
        if (res?.status === 200) {
      ...
      >
        ...
        <div className="overflow-y-auto px-6 py-5" style={{ maxHeight: "calc(90vh - 72px)" }}>
          ...
          <div className="relative mb-5 flex items-center">
            ...
            <span className="mx-3 text-xs" style={{ color: "var(--color-text-muted)" }}>or edit manually</span>
            <div className="flex-1 border-t" style={{ borderColor: "var(--color-border)" }} />
          </div>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="ea-name" className="mb-1.5 block text-sm font-medium" style={{ color: "var(--color-charcoal)" }}>
              ...
              <div>
                <label htmlFor="ea-mobile" className="mb-1.5 block text-sm font-medium" style={{ color: "var(--color-charcoal)" }}>
            ...
            {/* Pincode */}
            <div>
              <label htmlFor="ea-pincode" className="mb-1.5 flex items-center gap-2 text-sm font-medium" style={{ color: "var(--color-charcoal)" }}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="ea-city" className="mb-1.5 block text-sm font-medium" style={{ color: "var(--color-charcoal)" }}>
              ...
              <div>
                <label htmlFor="ea-state" className="mb-1.5 block text-sm font-medium" style={{ color: "var(--color-charcoal)" }}>
            ...
            {/* Street address */}
            <div>
              <label htmlFor="ea-street" className="mb-1.5 block text-sm font-medium" style={{ color: "var(--color-charcoal)" }}>
