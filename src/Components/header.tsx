        ...
        <div className="menu-sticky">
          <div className="menu-top d-flex align justify-content">
            <div className="menu-logo">
              <div className="rounded-full overflow-hidden ">
                <Image className="w-full h-full object-cover" src="https://res.cloudinary.com/doz4dnf0h/image/upload/w_1000,ar_1:1,c_fill,g_auto,e_art:hokusai/v1744734631/WhatsApp_Image_2025-04-06_at_6.43.54_PM_b6bdxm.jpg" alt="logo" width={100} height={100} />
              </div>
            </div>
            <div className="menu-name">
              <div className="attrismheading">{token ? user?.name : 'Attri'}</div>
              {!token ? (
              <Link href='/signup' className="d-flex align justify-content">
                ...
                <Link href='/myaccount' className="d-flex align justify-content" onClick={() => setIsOpen(false)}>
                Profile
                <svg width="15" height="15" viewBox="0 0 6 10" fill="none"><path d="M1 1l4 4-4 4" stroke="#2E3642" stroke-linecap="round"></path></svg>
              </Link>
              )}
          ...
          <div className="nav-menu">
            <ul className="nav-list">
              <li>
                <Link href='/privacypolicy' onClick={() => setIsOpen(false)}>
                  Privacy Policy
                </Link>
              </li>
              <li>
